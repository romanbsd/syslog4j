...
public class PCISyslogMessageTest extends TestCase {
    public static class TestSyslogMessage implements PCISyslogMessageIF {
    ...
    public void testPCISyslogMessageDefaultConstructor() throws Exception {
        ...
        assertEquals("undefined undefined " + date + " " + time + " undefined " + localHostName + " undefined",
                event.createMessage());
    }

    public void testPCISyslogMessage() throws Exception {
        PCISyslogMessage event1 = new PCISyslogMessage("admin123",
                "password_reset",
                "11/01/2008",
                "00:30:00",
                "success",
        ...
        assertEquals("admin123 password_reset 11/01/2008 00:30:00 success database_server user123",
                event1.createMessage());

        //

        PCISyslogMessage event2 =
                new PCISyslogMessage("admin123", "password_reset", "11/01/2008", "00:30:00", "success", "user123");

        String localHostName = InetAddress.getLocalHost().getHostName();
        assertEquals("admin123 password_reset 11/01/2008 00:30:00 success " + localHostName + " user123",
                event2.createMessage());
        ...
        assertEquals(
                "admin123 password_reset " + event3.getDate() + " " + event3.getTime() + " success " + localHostName
                        + " user123", event3.createMessage());

        //

        PCISyslogMessage event4 =
                new PCISyslogMessage("admin123", "password_reset", "success", "database_server", "user123");
        String time4 = event4.getTime();
        event4.setTime(time4);

        assertEquals("admin123 password_reset " + event4.getDate() + " " + event4.getTime()
                + " success database_server user123", event4.createMessage());
        ...
        PCISyslogMessage event6 =
                new PCISyslogMessage("admin123", "password_reset", new Date(), "success", "database_server", "user123");
    ...
    public void testPCISyslogMessageNulls() throws Exception {
        ...
        PCISyslogMessage event;

        event = new PCISyslogMessage(null, null, null, null);
        event.setTime(event.getTime());
        assertEquals("undefined undefined " + event.getDate() + " " + event.getTime() + " undefined " + localHostName
                + " undefined", event.createMessage());
    ...
    public void testPCISyslogMessageReplaceDelimiters() throws Exception {
        ...
        event.setTime(event.getTime());
        assertEquals(
                "a_b_c _d_e_f " + event.getDate() + " " + event.getTime() + " g_h_i_ " + localHostName + " _j_k_l_",
                event.createMessage());
    }

    public void testPCISyslogMessageMap() {
    ...
    public void testPCISyslogMessageIF() {
