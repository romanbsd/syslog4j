...
public abstract class AbstractNetSyslog4jTest extends AbstractBaseTest {
    ...
    protected static class RecorderHandler implements SyslogServerSessionEventHandlerIF {
        ...
        protected final List<String> recordedEvents = new LinkedList<>();
    ...
    protected final RecorderHandler recorderEventHandler = new RecorderHandler();
    ...
    protected void verifySendReceive(List<String> events, boolean sortEvents, boolean sortRecordedEvents, int threads) {
        ...
        while (!done) {
            ...
            String detail =
                    "Count: " + perc + "% " + recordedEventCount + "/" + eventCount + " : " + ClientThread.active;
    ...
    public void _testThreadedSendReceive(
            int threads,
            boolean sortEvents,
            boolean sortRecordedEvents,
            List<String> backLogEvents) {
        List<String> events = new ArrayList<>();
